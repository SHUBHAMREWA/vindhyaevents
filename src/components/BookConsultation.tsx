      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="grid lg:grid-cols-2 gap-8 items-center max-w-7xl mx-auto">
          ...
          <motion.div
            ...
            transition={{ duration: 0.8 }}
          >
            <div className="bg-white p-4 lg:p-6 shadow-2xl border border-rose-100 rounded-xl">
              <form onSubmit={handleSubmit} className="space-y-3">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-1.5 border border-gray-200 rounded-lg focus:border-rose-400 focus:ring-2 focus:ring-rose-200 transition-all duration-300 bg-gray-50/50"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-1.5 border border-gray-200 rounded-lg focus:border-rose-400 focus:ring-2 focus:ring-rose-200 transition-all duration-300 bg-gray-50/50 min-h-[60px]"
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  className="w-full py-2.5 bg-gradient-to-r from-rose-500 to-rose-600 text-white rounded-full hover:from-rose-600 hover:to-rose-700 transition-all duration-300 shadow-lg hover:shadow-xl flex items-center justify-center gap-2 group"
                >
